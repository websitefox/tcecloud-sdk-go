...
func NewModifyIp6AddressesAttributeRequest() (request *ModifyIp6AddressesAttributeRequest) {
	request = &ModifyIp6AddressesAttributeRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("vpc", APIVersion, "ModifyIp6AddressesAttribute")
	return
}

func NewModifyIp6AddressesAttributeResponse() (response *ModifyIp6AddressesAttributeResponse) {
	response = &ModifyIp6AddressesAttributeResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}

// 本接口（ModifyIp6AddressesAttribute）用于修改IPV6地址属性。
func (c *Client) ModifyIp6AddressesAttribute(request *ModifyIp6AddressesAttributeRequest) (response *ModifyIp6AddressesAttributeResponse, err error) {
	if request == nil {
		request = NewModifyIp6AddressesAttributeRequest()
	}
	response = NewModifyIp6AddressesAttributeResponse()
	err = c.Send(request, response)
	return
}
